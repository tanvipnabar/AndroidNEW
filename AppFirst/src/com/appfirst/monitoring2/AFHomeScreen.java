...
import com.appfirst.activities.lists.AFUserProfile;
...
public class AFHomeScreen extends Activity {
	...
	private Button btnToggleUserProfile;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnToggleUserProfile = (Button) findViewById(R.id.button2);
		...
		btnToggleUserProfile.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(AFHomeScreen.this, AFUserProfile.class);
