...
public class MainApplication extends Application {
	...
	private static List<UserProfile> userList;
	...
	public static synchronized List<UserProfile> getUserList() {
		return userList;
	}
	...
	public static synchronized void loadUserList(String url) {
		userList = client.getUserList(url);
	}
